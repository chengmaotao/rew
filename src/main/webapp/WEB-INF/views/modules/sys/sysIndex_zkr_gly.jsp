...
<head>
	...
	<style type="text/css">
		...
		#header .brand {width:332px;font-family:Helvetica, Georgia, Arial, sans-serif, 黑体;font-size:22px;font-weight:
	...
	<script type="text/javascript">
		$(document).ready(function() {
			...
			$("#menu a.menu").click(function(){
				...
				$("#menu li.dropdown").removeClass("activ");
	...
	<div id="main">
		<div id="header" class="navbar navbar-fixed-top navbar-default">
			<div class="navbar-inner" style="max-height: 60px">
				<div class="brand" style="padding:14px 20px 0 16px"><img src="${ctxStatic}/zkr/cxs/images/logo3.png"><span>海洋工程科学技术奖</span></div>
				...
				<ul id="menu" class="nav navbar-nav navbar-right" style="*white-space:nowrap;float:none;">
						...
						<c:forEach items="${fns:getMenuList0()}" var="menu" varStatus="idxStatus">
