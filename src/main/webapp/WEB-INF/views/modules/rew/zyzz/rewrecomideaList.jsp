	...
	<table id="contentTable" class="table table-striped table-bordered table-condensed">
		<thead>
			<tr>
			    ...
			    <c:if test="${!isShow }">
					<shiro:hasPermission name="zyzz"><th>操作</th></shiro:hasPermission>
				</c:if>
			</tr>
		</thead>
		<tbody>
		<c:forEach items="${page.list}" var="rewrecomidea" varStatus="s">
			<tr>
				...
				<c:if test="${!isShow }">
					<shiro:hasPermission name="zyzz"><td>
	    				<a href="${ctx}/zyzz/rewrecomidea/form?id=${rewrecomidea.id}&projectId=${rewrecomidea.projectid}">推荐意见</a>
	    				&nbsp;&nbsp;
	    				<a href="${ctx}/zyzz/rewrecomidea/form?id=${rewrecomidea.id}&projectId=${rewrecomidea.projectid}">修改</a>
